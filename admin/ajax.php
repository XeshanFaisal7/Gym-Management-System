...
if($action == "delete_announcement"){
	$delete = $crud->delete_announcement();
	if($delete)
		echo $delete;
}
...
if($action == "save_joiner"){
	$save = $crud->save_joiner();
	if($save)
		echo $save;
}

if($action == "update_joiner"){
	$save = $crud->update_joiner();
	if($save)
		echo $save;
}

if($action == "delete_joiner"){
	$save = $crud->delete_joiner();
	if($save)
		echo $save;
}
