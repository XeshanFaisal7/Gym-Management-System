...
$query="SELECT * FROM `announcements` WHERE `date_created`='$current_date' AND `audience`='trainers' order by id DESC";
...
{
$query2 = "INSERT INTO `admin_announcement`(`announcement_title`, `announcement`,`status`) VALUES ('$announcement_title','$announcement','0')";
...
<html lang="en">
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
           ...
           <h5 style="color: #FFFFFF ; text-align: center;"><?php echo $row['name']?></h5>
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li>
	              <a href="trainer_hired.php">Joiners Who Hired Me</a>
	          </li>
              
                  <li>
                <a href="daily_workout_information.php">Post Daily Workout Information</a>
            </li>
             <li>
                <a href="workout_informations.php">Daily Workout Information</a>
            </li>
              <li>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="trainer_hired.php">Joiners Who Hired Me</a>
                </li>
